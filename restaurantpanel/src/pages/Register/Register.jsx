    ...
    <div className="auth-container">
      <div className="auth-card shadow-lg">
        <div className="text-center mb-4 auth-header">
          <i className="bi bi-person-plus-fill" style={{background: 'linear-gradient(45deg, #28a745, #85ef9e)', WebkitBackgroundClip: 'text', backgroundClip: 'text'}}></i>
        ...
        <form onSubmit={onSubmitHandler}>
          <div className="mb-3">
            ...
            <input type="text" name="name" className="form-control" required
              value={data.name} onChange={onChangeHandler} placeholder="Enter your name" />
          </div>
          <div className="mb-3">
            <label className="form-label">Email address</label>
            <input type="email" name="email" className="form-control" required
              value={data.email} onChange={onChangeHandler} placeholder="Enter your email" />
          </div>
          <div className="mb-3">
